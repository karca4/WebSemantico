...
/**
 * Generated class for the ArchitetturaPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-architettura',
  templateUrl: 'architettura.html',
})
export class ArchitetturaPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,private jena: JenaProvider,private iab: InAppBrowser) {
    this.jena.getArchitettura().then((data) => {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ArchitetturaPage');
  }
